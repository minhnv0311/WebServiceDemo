...
namespace WebApiCore.Models
{
    ...
    public partial class QL_TaiLieu
    {
        ...
        public string CoQuanXinCapPhep { get; set; }
        public Nullable<System.DateTime> NgayCapPhep { get; set; }
        public string KhuonKho { get; set; }
        public Nullable<int> SoTrang { get; set; }
        public string CoSoIn { get; set; }
        public string DonDeNghi { get; set; }
