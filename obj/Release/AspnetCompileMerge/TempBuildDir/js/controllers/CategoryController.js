angular.module('WebApiApp').controller("ModelCMSCategoriesHandlerController", function ($rootScope, $scope, $http, $uibModalInstance) {
    
    $scope.itemMenu = $scope.$resolve.item;
    ...
    $scope.SaveModal = function () {
        ...
        else
        {
            $http({
                method: 'PUT',
                url: '/api/CMS_Categories/' + $scope.itemMenu.Id,
                data: $scope.itemMenu
            }).then(function successCallback(response) {
    ...
    $scope.ValidOnlyCode = function (FCode) {
        ...
        $http({
            method: 'GET',
            url: '/api/ApiCMS_Categories/CMS_Categories/CheckValidMenu',
            params: { fcode: FCode }
        }).then(function successCallback(response) {
    ...
    $scope.types = [
        { value: "TOP", text: "Hiển thị phía trên" },
        { value: "LEFT", text: "Hiển thị phía bên trái" },
        { value: "BOTTOM", text: "Hiển thị phía dưới" },
    ];
...
angular.module('WebApiApp').controller('CategoryController', ['$rootScope', '$scope', '$http', '$cookies', '$uibModal', '$settings', '$timeout', function ($rootScope, $scope, $http, $cookies, $uibModal, $settings, $timeout) {
        ...
        $http({
           ...
           // console.log(response.data);
            ...
            $('#tree_3').on("select_node.jstree", function (e, data) {
                ...
                $http({
                    method: 'GET',
                    url: '/CMS_Categories/MenuByGroup/' + data.node.original.code
                }).then(function successCallback(response) {
                    $scope.MenuLevel = response.data;
            ...
            //$('#tree_3').on('dnd_stop.vakata', function (e, data) {
            //    console.log('Dropped');
            //});
    ...
    $scope.UpdateTree = function () {
        ...
        $http({
            method: 'POST',
            url: '/api/ApiCMS_Categories/CMS_Categories/UpdateTree',
            data: dt,
