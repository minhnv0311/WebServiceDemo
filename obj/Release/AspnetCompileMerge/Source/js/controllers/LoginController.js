...
WebApiApp.controller('LoginController', ['$rootScope', '$scope', '$http', '$cookies', '$settings', 'loginAppFactory', function ($rootScope, $scope, $http, $cookies, $settings, loginAppFactory) {
    ...
    $scope.$on('$viewContentLoaded', function () {
        ...
        $('.login-bg').backstretch([
                    "../assets/pages/img/login/bg-global4.jpg",
            "../assets/pages/img/login/screen_homepage_en.jpg",
                    "../assets/pages/img/login/bg-global5.jpg",
                    "../assets/pages/img/login/bg-global3.jpg",
            ], {
                fade: 1000,
                duration: 8000
            }
