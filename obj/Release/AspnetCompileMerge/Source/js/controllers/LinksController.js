angular.module('WebApiApp').controller('LinksController', ['$q','$rootScope', '$scope', '$http', '$cookies', '$uibModal', '$settings', '$timeout', function ($q,$rootScope, $scope, $http, $cookies, $uibModal, $settings, $timeout) {
    $scope.$on('$viewContentLoaded', function () {
        ...
        $scope.LoadGroupLinks('link').then(data => {
            $scope.GetListBanner();
        });
