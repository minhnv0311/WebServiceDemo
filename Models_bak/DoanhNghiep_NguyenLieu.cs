namespace WebApiCore.Models
{
    ...
    public partial class DoanhNghiep_NguyenLieu
    {
        ...
        public string TenNguyenLieu_VI { get; set; }

        public string TenNguyenLieu_EN { get; set; }
        ...
        [StringLength(100)]
        public string TyTrongNhapKhau { get; set; }

        public string TenNuocNhapKhau { get; set; }
